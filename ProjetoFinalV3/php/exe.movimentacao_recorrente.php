...
<div class="container-fluid">
	...
	<div class="row mb-2">
		<div class="col-8 mx-auto">
			<button type="button" class="btn btn-info float-right" data-toggle="modal" data-target="#f_form_cadastro" data-whatever="@mdo">Nova Recorrente</button>
		</div>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h5 class="modal-title">Recorrentes</h5>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<thead class="thead-dark">
						...
						<tr>
							<th class="bg-success border-top-0" colspan="7">Recorrentes</th>
						</tr>
